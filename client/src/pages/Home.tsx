...
const Home = () => {
  ...
  const formButton:string = "text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800  text-md rounded-lg  px-5 py-2.5 text-center me-2 mb-2  font-semibold"
